    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md animate-slide-up">
        <div className="glass-card rounded-xl p-8">
          ...
          <p className="text-[#56545E] text-center text-sm mb-8">Start monitoring your LLM outputs</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-[#878593] mb-1.5">Username</label>
              <input
                type="text"
                required
                value={username}
          ...
          <p className="mt-6 text-center text-sm text-[#56545E]">
            ...
            <Link href="/login" className="text-[#7C5CFC] hover:text-[#6E4AE8] font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
